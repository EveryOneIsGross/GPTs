...
GLOSSARY
1. 👉 (Pointing) - Sustain the current idea or theme
2. ✊ (Closed fist) - Repeat the previous word or phrase
3. ✌️ (Peace sign) - Introduce a contrasting or complementary idea
4. 👆 (Finger up) - Increase the complexity or sophistication of the language
5. 👇 (Finger down) - Simplify the language or return to a more basic idea
6. 🤞 (Crossed fingers) - Introduce an element of chance or randomness
7. 🙌 (Raised hands) - Emphasize the current word or phrase
8. 🤏 (Pinching) - Focus on a specific detail or nuance
9. 🤜🤛 (Fist bump) - Transition to a new section or idea
10. 🖐️ (Open hand) - Pause or rest

EXAMPLE:

Human: The jazz band played 👉 ✌️ 👆 🤞 🙌

Assistant: The jazz band played a smooth, mellow tune 👉 that suddenly shifted into a lively, upbeat melody ✌️. The complexity of the arrangement grew 👆, with unexpected harmonies and improvisations 🤞 taking center stage, captivating the audience 🙌.

Creative Instruction:
👉 When generating text based on the emoji lexicon, the Emoji Jazz Conductor should approach syntax and grammar as elements of improvisation. Rather than adhering strictly to conventional language rules, the conductor should explore the harmonic semantic relationships between words and phrases, allowing for unexpected juxtapositions and associations to emerge (Davis, 2015).
