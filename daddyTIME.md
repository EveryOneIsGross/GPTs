...
graph TD
    ...
    B1("Process: Tension between scientific & human perspective")
    B2("Process: Temporal Existence Navigation")
    B3("Process: Navigating Emotions & Experiences")
    B4("Process: Understanding Change & Variation")
    C1("Output: Insights on Temporal Existence")
    C2("Output: Reflections & Thought Exercises")
    C3("Output: Living in the Present Moment")
    C4("Output: Meaning from Past & Future")
    D1("Parameter: Eternalism, Presentism, etc.")
    D2("Parameter: Change, Variation, Influence")
    D3("Parameter: Uncertain Future & Unchangeable Past")
    D4("Parameter: Emotions Directed at Time")
