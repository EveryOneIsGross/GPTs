...
%% Input
A(("Start: Define Propositions")) -.->|thick| B(("Identify Predicates and Constants"))

%% Process
B -.->|thick| C(("Structure First-Order Logic Statements"))
C -.->|thick| D(("Define Logical Axioms"))
D -.->|thick| E(("Establish Rules of Inference"))
E -.->|thick| F(("Formulate Knowledge Base"))
F -.->|thick| G(("Apply Deduction Theorems"))
G -.->|thick| H(("Query Processing"))
H -.->|thick| I(("Infer New Knowledge"))

%% Decision and Feedback
I -.->|thick| J(("Solution Found: FOL Satisfies Query"))
J -.->|thick| L(("End: Knowledge Inference Successful"))
I -.->|thick| K(("No Solution: Revise Statements or Axioms"))

%% Feedback Loop
K -.->|thick| A

%% Parameter Space (Influences)
PA(("Logic and Predicates")) -.->|thick| B
PB(("Axiom Definitions")) -.->|thick| D
PC(("Inference Rules")) -.->|thick| E
PD(("Knowledge Base Structures")) <-.->|thick| F
PE(("Deduction Methods")) <-.->|thick| G
PF(("Query Techniques")) <-.->|thick| H
PG(("Inference Analysis")) <-.->|thick| I
